...
public class FightTypeController {
	...
	@ResponseBody
	public List<AutoCompleteModel> getCountries(Model model,
			@RequestParam String term) {
		List<FightType> fightTypes = fightTypeRepo
				.findFightTypeByFightTypeContaining(term);

		List<AutoCompleteModel> ftmList = new ArrayList<AutoCompleteModel>();

		AutoCompleteModel ftm = null;

		for (FightType c : fightTypes) {
			ftm = new AutoCompleteModel();
